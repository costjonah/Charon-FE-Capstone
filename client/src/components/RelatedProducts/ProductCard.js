...
class ProductCard extends React.Component {
  ...
  render() {
    ...
    const relatedProduct =
      (this.props.product && this.props.product.relatedProducts && this.props.product.relatedProducts[0]) || null
    const relatedProductPhoto =
      relatedProduct && Array.isArray(relatedProduct.styles) && relatedProduct.styles[0].photos[0].thumbnail_url
        ...
        <div className='card'>
          ...
          <div className='card-body'>
            <div className='product-detail'>
              ...
              <div className='item'>
                ...
                <div className='item-value text-danger font-weight-bold'>$ {this.props.product.default_price}</div>
              </div>
            </div>
          ...
          <div className='card-footer footer-info'>
            ...
            <div className='card-btn-group'>
              <a onClick={() => this.openModal(this.props.product.id)}>
                <svg
              ...
              {this.props.outfit && <a onClick={handleRemoveProductFromOutfits}>Remove</a>}
            </div>
          </div>
        </div>
      </div>
